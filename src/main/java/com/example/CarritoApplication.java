...
public class CarritoApplication {
	...
	public CommandLineRunner init() {
		return args -> {
			...
			instrumento.setImagen("https://images.unsplash.com/photo-1561758423-4a993d30afea?q=80&w=1466&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
			instrumento.setPrecio(15.0);
